...
echo "celkem nalezeny pocet pripojenych USB jednotek - $d_results"
echo ""
...
# # upraveno 3.4.2026
# presunuto sen, bude spolecne pro vsechny a bude se nulovat po kazdem pruchdu for $aa cykem
...
# pridano 3.4.2026
# SD karta 32 Gb v redukci, vyhodnocuje se i velikost karty - 31914086400 - UInt63 - modre ( redukce je modra )
if (
...
# SD karta 4Gb v redukci - modre
# SN je cislem redukce samotne, nikoliv SD karty v redukci takze je potreba vyhodnotit jeste velikost karty cca. 4GB
if (
...
#Copy-Item "C:\Users\DELL\Documents\zaloha\firefox_hesla.rar" "$jednotka_pismeno\firefox_hesla.rar" -Force # opraveno 23.4.2026
